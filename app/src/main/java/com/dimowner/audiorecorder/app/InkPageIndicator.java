 ...
 */
public class InkPageIndicator extends View implements
        View.OnAttachStateChangeListener
{
    ...
    public void setViewPager(ViewPager2 viewPager)
    {
        ...
        final RecyclerView.Adapter vpAdapter = viewPager.getAdapter();
        if (vpAdapter != null)
        {
            setPageCount(vpAdapter.getItemCount());
            vpAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver()
            {
                @Override
